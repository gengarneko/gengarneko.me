...
description: '交互式深入 Framer Motion 的 状态传递、渐进退出和布局动画。'
date: '2022-04-20'
updated: '2022-08-04'
tags: ['framer motion', 'animation', 'frontend', 'ui', 'ux', 'design', 'react']
authors: ['gengarneko']
slug: animation-patterns-with-framer-motion
---

import AdvancedFramerMotionSandpack from '@/components/mdx/Widgets/AdvancedFramerMotion/FramerMotionSandpack.tsx';

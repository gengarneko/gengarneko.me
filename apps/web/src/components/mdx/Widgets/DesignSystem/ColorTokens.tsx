import * as DesignSystem from '@maximeheckel/design-system';
const { Box, Button, Card, Flex, Grid, Icon, Text, Tooltip, useTheme } =
  DesignSystem;

import LightDarkSwitcher from '@/components/mdx/Buttons/LightDarkSwitcher';

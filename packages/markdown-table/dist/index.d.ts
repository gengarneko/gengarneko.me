declare type MarkdownTableCell = string | null | undefined;
declare type MarkdownTable = MarkdownTableCell[][];
...
declare const markdownTable: (table: MarkdownTable, options?: MarkdownTableOptions | undefined) => string;

...
function updatePackageJsonDetails(
	...
	const updatedName = updatePackageName(packageJson, fullPath);
	const updatedVersion = updateVersion(updatedName);
	const updatedAuthor = updateAuthor(updatedVersion);
	const updatedLicense = updateLicense(updatedAuthor);
